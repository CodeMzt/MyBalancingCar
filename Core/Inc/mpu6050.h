...
#define MPU_IIC_Init			MyI2C_Init
#define MPU_IIC_Start			MyI2C_Start
#define MPU_IIC_Stop			MyI2C_Stop
#define MPU_IIC_Send_Byte		MyI2C_SendByte
#define MPU_IIC_Read_Byte		MyI2C_ReceiveByte
#define MPU_IIC_Wait_Ack		MyI2C_ReceiveAck
